"""
Rimmel Brand Monitor — Webhook-driven version.

This script is invoked by a GitHub Actions workflow that triggers on
`repository_dispatch` (event_type: qogita_catalog_rimmel), fired by a
...
BRAND_DISPLAY_NAME = "Rimmel"
SNAPSHOT_FILE    = "snapshot_qogita_rimmel_brand.json"
BASELINE_FLAG    = "baseline_done_rimmel_brand.txt"
...
DISCORD_WEBHOOK  = os.getenv("DISCORD_WEBHOOK_RIMMEL", "")
