"""
Qogita Makeup Category Monitor — Webhook-driven version.

This script is invoked by a GitHub Actions workflow that triggers on
`repository_dispatch` (event_type: qogita_catalog_makeup), fired by a
...
CSV columns (confirmed from a real Makeup category download):
...
SNAPSHOT_FILE    = "snapshot_qogita_makeup_category.json"
BASELINE_FLAG    = "baseline_done_makeup_category.txt"
